                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form-sample">
                      ...
                      <br>
                      <center> <input type="submit" value="Add Info">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="reset" value="Reset Info"></center>
                    </form>
                  </div>
                </div>
              </div>
    ...
    <script src="../../assets/js/todolist.js"></script>
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample">
                      <br>
                      <h2 > <a href="Employee.php" class="h">Employee</a></h2>
                      <p class="card-description"> Personal info </p>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
